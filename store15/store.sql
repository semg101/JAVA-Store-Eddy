...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 02, 2018 at 03:18 PM
...
INSERT INTO `carts` (`id`, `user_session_id`, `image`, `message`, `price`, `quantity`, `product_id`, `category_id`, `sex`) VALUES
(27, 1519430341183, '2.jpg', '', '47.95', 5, 82, 4, 'women'),
(26, 1519430341183, '3.jpg', NULL, '65.50', 1, 93, 5, 'women'),
(19, 1519430374633, '3.jpg', '', '75.50', 3, 33, 4, 'men'),
(24, 1519430341183, '3.jpg', '', '75.50', 8, 33, 4, 'men'),
(25, 1519430341183, '2.jpg', NULL, '87.95', 1, 32, 4, 'men'),
(28, 1519430374633, '9.jpg', NULL, '120.50', 1, 99, 5, 'women'),
(29, 1522144668263, '2.jpg', NULL, '87.95', 1, 32, 4, 'men'),
(30, 1522144598529, '2.jpg', '', '157.95', 1, 42, 5, 'men'),
(31, 1522144598529, '9.jpg', '', '10.50', 45, 9, 1, 'men'),
(32, 1522144598529, '10.jpg', '', '88.95', 10, 40, 4, 'men'),
(33, 1522144668263, '3.jpg', NULL, '75.50', 1, 33, 4, 'men'),
(34, 1522144598529, '3.jpg', NULL, '65.50', 1, 93, 5, 'women');
...
INSERT INTO `customers` (`id`, `email`, `first_name`, `last_name`, `address`, `city`, `country`, `zip_code`, `telephone`, `date_created`) VALUES
(1, 'g', 'h', 'y', 'yu', 'fgf', 'fg', '', '', '2018-03-27 15:59:27'),
(2, 'gh.gh@yahoo.com', 'Catherine', 'Anderson', '12 Small Bull', 'Solihull', 'England', 'SC2 1KL', '004412356899899', '2018-03-30 14:43:38');
...
CREATE TABLE `orders` (
  ...
  `credit_card_number` mediumint(4) DEFAULT NULL,
...
INSERT INTO `orders` (`id`, `customer_id`, `total`, `credit_card_number`, `order_date`) VALUES
(15, 'gh.gh@yahoo.com', '1585.45', 6487, '2018-03-31 18:56:49');
...
CREATE TABLE `receipt` (
  ...
  `proceeded` enum('No','Yes') NOT NULL,
...
INSERT INTO `receipt` (`id`, `proceeded`, `customer_id`, `product_id`, `price`, `quantity`, `total`, `date_created`) VALUES
(44, 'No', 'gh.gh@yahoo.com', 93, '65.50', 1, '65.50', '2018-03-31 18:56:50'),
(43, 'No', 'gh.gh@yahoo.com', 40, '88.95', 10, '889.50', '2018-03-31 18:56:50'),
(42, 'No', 'gh.gh@yahoo.com', 9, '10.50', 45, '472.50', '2018-03-31 18:56:50'),
(41, 'No', 'gh.gh@yahoo.com', 42, '157.95', 1, '157.95', '2018-03-31 18:56:50');
...
INSERT INTO `transaction` (`id`, `response_code`) VALUES
(1, '1');
...
--
ALTER TABLE `carts`
  MODIFY `id` mediumint(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
--
...
--
ALTER TABLE `receipt`
  MODIFY `id` mediumint(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;
--
