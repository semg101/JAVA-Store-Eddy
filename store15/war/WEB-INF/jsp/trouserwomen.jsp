          ...
          <c:forEach items="${model.products}" var="prod">
            <li class="portfolio-item apps">
                <div class="item-inner">
                    <img src="images/trouserswomen/<c:out value="${prod.image}"/>"  alt="">
                    <h6>SIZE:<c:out value="${prod.size}"/></h6>
                    <div class="overlay">
                        <a class="preview btn btn-danger" href="images/trouserswomen/<c:out value="${prod.image}"/>" rel="prettyPhoto"><i class="icon-eye-open"></i></a> 
