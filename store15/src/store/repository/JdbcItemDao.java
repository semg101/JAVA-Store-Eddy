...
public class JdbcItemDao extends SimpleJdbcDaoSupport implements ItemDao{
	 ...
	 /** Logger for this class and subclasses */
	  ...
	  public void add_order(Object customer_id, Object total, String card_number){
		@SuppressWarnings("unused")
		int count = getSimpleJdbcTemplate().update(
		    		"insert into orders (customer_id, total, credit_card_number) values " +
		    				"(?, ?, ?)",
		    				customer_id,
		    				total,
		    				card_number);
	...
	//Add customer's details
	  ...
	  //add a receipt
      public void add_receipt(List<Item> listItems, Object customer_id){
    	  for (Item item : listItems) {
    		  int count = getSimpleJdbcTemplate().update(
  		    		"insert into receipt (customer_id, product_id, price, quantity, total) values " +
  		    				"(?, ?, ?, ? ,?)",
      ...
      //add transaction
      public void add_transaction(String response_code){
    	  int count = getSimpleJdbcTemplate().update(
		    		"insert into transaction (response_code) values " +
		    				"(?)",
