          ...
          <table class="table">
           ...
           <c:forEach items="${model.items}" var="item"> 
               ...
               <td>
                        ...
                        <form class="navbar-form navbar-left" role="search">
                          <div class="form-group">
                            ...
                            <input type="text" name="quantity" class="form-control" value="<c:out value="${item.quantity}"/>">
                          </div>
                          ...
                          <input type="hidden" name="id" value="<c:out value="${item.product_id}"/>" />
            ...
            <tr>
               ...
               <td>
                   <div>
                        <form  action="viewcart.htm?action="""  class="navbar-form navbar-left" role="search">
                          <div class="form-group">
                          ...
                          <!--  <button type="submit" class="btn btn-default">Update</button>
                          <button type="submit" class="btn btn-default">Delete</button>
                          <a href="<c:url value="viewcart.htm?id=5&action=add"/>"">Update</a>
                          <a href="<c:url value="viewcart.htm?id=5&action=add"/>"">Delete</a>-->
